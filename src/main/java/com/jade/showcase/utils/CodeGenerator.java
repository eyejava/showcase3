...
public class CodeGenerator {
   ...
   //     pc.setController("com.jade.showcase");
    ...
    //    pc.setService("com.jade.showcase");
        ...
        strategy.setSuperEntityClass("com.jade.showcase.common.BaseEntity");
        strategy.setEntityLombokModel(true);
        strategy.setRestControllerStyle(true);
        strategy.setSuperControllerClass("com.jade.showcase.common.BaseController");
